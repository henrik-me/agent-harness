...
```bash
# In a consumer repo:
npx -y github:henrik-me/agent-harness#v0.6.0 init
# review the generated harness.config.json, then:
npx -y github:henrik-me/agent-harness#v0.6.0 sync
```
