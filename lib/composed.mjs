...
// the HTML form only. Keep these two constants byte-identical to the mirror in
// scripts/check-composed-blocks.mjs so the two hand-synced parsers never drift.
