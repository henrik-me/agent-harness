 ...
 * consumers that never set the key. `0.0.0-pre` is the self-host placeholder
 * version and is treated as "no usable ref"; the self-host overrides
 * `harness_invoke` in its own config anyway, so it never renders this default.
 *
