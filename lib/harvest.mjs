 ...
 * § Harvest Cadence); this module is the real implementation that
 * `bin/harness.mjs` `cmdHarvest` delegates to (CS63b wired it, replacing the
 * former `die` stub). It is a pure function over the file text + an injected
