...
function normalizeReviews(reviews, { configPath, schema }) {
  ...
  // schema minLength:1 on rubber_duck_model/fallback_model/copilot_reviewer_slug
  // and preserves the check-independence-invariant gold-standard rubber_duck_model
  // handling being factored out here.
