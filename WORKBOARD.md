...
|------------|-------|-------|-------|--------|--------------|----------------|
| CS96 | CS96 — cut harness v0.14.0 (Minor) | 🟢 Active | yoga-ah | cs96/content | 2026-07-03 | — |
| CS97 | CS97 — check-commit-trailers: strip git comment/scissors lines before trailer detection | 🟢 Active | yoga-ah-c2 | cs97/content | 2026-07-03 | — |
