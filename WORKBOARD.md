...
|------------|-------|-------|-------|--------|--------------|----------------|
| CS76 | CS76 — Composed process-doc cross-ref resolvability: close #229 + fold in CS81-R3 docs/adr links, via an extended guard | 🟢 Active | yoga-ah | cs76/content | 2026-07-04 | — |
| CS86 | CS86 — Deeper OPERATIONS.md right-sizing: relocate the extracted preamble source + thin the reviewer-preamble section | 🟢 Active | yoga-ah-c2 | cs86/content | 2026-07-04 | — |
