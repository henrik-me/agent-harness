...
> **Last updated:** 2026-07-01 (omni-ah-c2 — CS65 PAUSED pending CS79 (release.yml idempotency guard, LRN-175); reclaimable by owner after CS79 close-out)
...
|------------|-------|-------|-------|--------|--------------|----------------|
| CS65 | CS65 — Process-doc right-sizing: OPERATIONS.md extraction + LEARNINGS.md archival | ⏸️ Paused | omni-ah-c2 | cs65/content | 2026-07-01 | Paused pending CS79 (release.yml idempotency guard, LRN-175); reclaimable by owner after CS79 close-out |
| CS79 | CS79 — `release.yml` idempotency guard (close the double-draft race, LRN-175) | 🟢 Active | omni-ah-c2 | cs79/content | 2026-07-01 | — |
